"NV.cpp" (Examples 2, 3, and 4)
	a. The input is file and "config.txt".
	b. The outputs are 
		1. "EX_%.2f.txt", where f denote the value of gamma. This includes the log of the algorithm iterations, CPU time, and information about the effectiveness of scenarios.		
		...
		3. "EX_Numbers_post.txt". Number of effective and ineffective scenarios after resolving undetermined scenarios.
		...
		8. "EX_Optimal.txt". Contains the set of optimal solutions at each value of gamma.
